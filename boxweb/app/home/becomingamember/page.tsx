...
export default function BecomingAMemberPage() {
            ...
            <header className="border-b bg-white fixed top-0 left-0 right-0 z-50 bg-background">
                <div className="flex items-center justify-between px-6 py-4 bg-background">
                    ...
                    {typeof window !== 'undefined' && window.innerWidth >= 768 ?
                        <div className="text-3xl font-semibold text-secondary">Becoming A Member</div>
                        :
                ...
                <div className="flex gap-6">
                    ...
                    <div className="w-full flex flex-col items-center justify-center">
                        ...
                        <div className="mb-6 flex flex-col items-center justify-center gap-2">
                            <h1 className="text-3xl font-bold mb-2">Discovery More Topics</h1>
                            <p className="text-primary text-center">
                                Discover different Creators, Publications, Magazines, and Podcasts.
                            </p>
                        </div>
