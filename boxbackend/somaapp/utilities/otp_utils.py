    ...
    <html>
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <p style="color: rgb(2, 8, 23);">Welcome to SOMA! To complete your account verification, please use the following One-Time Password (OTP):</p>
                ...
                <p style="color: rgb(2, 8, 23);">This OTP will expire in 10 minutes. Please enter it in the verification page to complete your account setup.</p>
                <p style="color: rgb(2, 8, 23);">If you didn't request this verification, please ignore this email.</p>
